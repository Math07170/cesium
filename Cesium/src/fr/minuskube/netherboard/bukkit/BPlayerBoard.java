...
public class BPlayerBoard implements PlayerBoard<String, Integer, String> {
    ...
    private void sendObjective(Objective obj, ObjectiveMode mode) {
        try {
            ...
            System.err.println("Error while creating and sending objective packet. (Unsupported Minecraft version?)"+ e);
        }
    }
    ...
    private void sendObjectiveDisplay(Objective obj) {
        try {
        	...
        	System.err.println("Error while creating and sending display packet. (Unsupported Minecraft version?)" + e);
        }
    }
    ...
    private void sendScore(Objective obj, String name, int score, boolean remove) {
        try {
        	...
        	System.err.println("Error while creating and sending remove packet. (Unsupported Minecraft version?)"+ e);
        }
    }
