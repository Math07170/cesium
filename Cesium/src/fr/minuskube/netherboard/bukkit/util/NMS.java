...
public class NMS {
    ...
    private static final Logger LOGGER = Logger.getLogger(NMS.class.getName());
    ...
    static {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Error while loading NMS methods. (Unsupported Minecraft version?)", e);
        }
        ...
        for(Player p : players) {
            try {
                ...
                SEND_PACKET.invoke(playerConnection, packet);
            	 ...
            	 LOGGER.log(Level.SEVERE, "Error while sending packet to player. (Unsupported Minecraft version?)", e);
            }
        }
    }
